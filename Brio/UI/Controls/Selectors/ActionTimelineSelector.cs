...
public class ActionTimelineSelector(string id) : Selector<ActionTimelineSelectorEntry>(id)
{
    ...
    {
        var description = $"{item.Name}\n{item.SecondaryId} {Localize.Text(item.TimelineType.ToString())} {Localize.Text(item.Slot.ToString())} {Localize.Text(item.Purpose.ToString())}\n{item.TimelineId} {item.Key}";
    ...
    protected override void DrawOptions()
    {
        ...
        var changed = ImBrio.ToggleSelecterStrip("actiontimeline_filters_selector", Vector2.Zero, ref items,
            [Localize.Text("Emotes"), Localize.Text("Actions"), Localize.Text("Timelines")]);
        ...
        if(ImBrio.ButtonSelectorStrip("emote_category_filter", Vector2.Zero, ref emoteCategorySelection,
            [global::Brio.Resources.Localize.Text("All"), global::Brio.Resources.Localize.Text("General"), global::Brio.Resources.Localize.Text("Special"), global::Brio.Resources.Localize.Text("Expression"), global::Brio.Resources.Localize.Text("Mod"), global::Brio.Resources.Localize.Text("Poses")]))
        {
